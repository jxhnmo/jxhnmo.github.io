        ...
        <div id="page-container" class="my-3">
            ...
            <div class="main">
                <div class="row lightContainer">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="instagram" url="https://www.instagram.com/jxhnmo/" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="spotify" url="https://open.spotify.com/user/the_dark_dragon" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="discord" url="https://discord.com/invite/CnzYRG6" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="twitch" url="https://www.twitch.tv/jomgos" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="linkedin" url="https://www.linkedin.com/in/john-mo/" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
                    ...
                    <div class="parent">
                        <div class="child">
                            <SocialIcon network="github" url="https://github.com/jxhnmo" style={{ width: 30 }} fgColor="#A991E0" bgColor="#2A1A38" />
                        </div>
                        <div class="child">
